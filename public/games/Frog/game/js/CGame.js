function CGame(oData){
    ...
    this.updateLogicPos = function(){
        ...
        console.log("[Frog updateLogicPos] Frog position (x,y):", _oFrog.getPos().x, _oFrog.getPos().y);
        ...
        console.log("[Frog updateLogicPos] Frog logical position (row, col):", _oCurLogicPos.row, _oCurLogicPos.col);
    ...
    this.updateScore = function(iValue){
        console.log("[Frog Game] Adding score:", iValue, "Current score before:", s_iScore);
        s_iScore += iValue;
        if(s_iScore<0){
            s_iScore = 0;
        }
        console.log("[Frog Game] New total score:", s_iScore);
    ...
    this._checkNewLevel = function(){
        console.log("[Frog _checkNewLevel] Called! _iFrogInNest before increment:", _iFrogInNest);
        _iFrogInNest++;
        console.log("[Frog _checkNewLevel] _iFrogInNest after increment:", _iFrogInNest);
        if(_iFrogInNest === 5){
    ...
    this.update = function(){
        ...
        if(_bStartGame){
            ...
            if(_oCurLogicPos.row  === 14){
                    console.log("[Frog row 14] Frog reached row 14, col " + _oCurLogicPos.col + ", nest status: " + _aNest[_oCurLogicPos.col] + ", all nests: ", _aNest);
                    
                    if(_aNest[_oCurLogicPos.col] === "free" || _aNest[_oCurLogicPos.col] === "fly"){
                        console.log("[Frog Reached Nest] Frog reached nest at column " + _oCurLogicPos.col + ", nest status: " + _aNest[_oCurLogicPos.col]);
                        ...
                        // Always add 100 points when frog reaches destination
                        console.log("[Frog Reached Nest] About to add 100 points");
