    ...
    <script>
        ...
        $(document).ready(function () {
            var oMain = new CMain({
                ...
                score_death: 0,    //Points losed when frog deads
            ...
            axios.get(apiUrl + '/leaderboard/22').then(function (res) {
            ...
            $(oMain).on("end_session", function (evt) {
                ...
                window.location.href = "https://coactx.live/siemens/Game-A-Thon2021/webcast.php";
                //...ADD YOUR CODE HERE EVENTUALLY
            });
            ...
            $(oMain).on("save_score", function (evt, iScore) {
                ...
                const body = { 'sessionId': session_id, 'username': username, 'email': email_id, 'gameId': 22, 'score': iScore, 'gameName': 'Jump Frog'};
